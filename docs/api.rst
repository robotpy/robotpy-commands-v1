...
legacy version of WPILib's Command-based programming.  Command
...
`FRC Control System documentation <https://docs.wpilib.org/en/latest/docs/software/old-commandbased/index.html>`_

.. note:: As of 2020, the legacy command framework is distributed separately
          from WPILib.
